...
//    at86rf215_reg_write(dev, AT86RF2XX_REG__PHY_CC_CCA, phy_cc_cca);
	...
	/*** Channel ***/
	at86rf215_reg_write(dev, dev->rf|AT86RF215_REG__CS, 0xC8);
	at86rf215_reg_write(dev, dev->rf|AT86RF215_REG__CCF0L, 0xD0);
	at86rf215_reg_write(dev, dev->rf|AT86RF215_REG__CCF0H, 0x84);
