 ...
 *
 * @param[in] timestamp          Pointer to the uint64_t to write the 
 *                               timestamp to.
 * @param[out] time              Pointer to the struct tm to store the 
 *                               converted timestamp.
 ...
 *
 * @param[in]  time        Pointer to the uint64_t timestamp.
