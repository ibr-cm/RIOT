...
static void _dmts_mac_calc_offset(void)
{
    ...
    if (dmts_pkt_valid)
    {
         ...
         *
         * For a sync interval of 1, 8 and 16 second, we have to get 33, 5 and 3 messages containing
         * timing information respectively. This ensures a 32 second interval over which the
         * clock drift will be calculated.
